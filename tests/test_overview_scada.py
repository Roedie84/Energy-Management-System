...
def test_the_bottom_bar_spans_the_full_width():
    ...
    # v5.19.1: het besluitblok is breder geworden zodat de uitleg en de
    # waarom-regel volledig passen; de balk ernaast is daardoor smaller.
    assert 'width="320"' in plaat
