...
| `test_diagnostics_extensions.py` | Diagnostiek-uitbreidingen: mode-change-log, gedateerde tekort-/overschot-historie, ruwe PV-forecast (v0.63.11), plus vakantie-/apparaat-velden (v0.47.0) |
