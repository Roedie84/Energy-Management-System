"""Steelstofzuiger charging control (v0.63.12): charges only during
today's cheapest price block, year-round, instead of a fixed clock
window - and turns itself off once charging is genuinely complete
(sustained low power draw), not on a guessed duration.
"""
import asyncio
