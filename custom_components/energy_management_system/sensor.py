...
class SystemStatusSensor(_CoordinatorDiagnosticSensor):
    ...
    @property
    def extra_state_attributes(self) -> dict:
        # v4.10: één aanroep. Stond twee keer in dezelfde
        # attributenopbouw.
...
class GacsAssessmentSensor(SensorEntity):
    ...
    def _bouw_attributen(self) -> dict:
        ...
        for sleutel, functie in (
            ...
            ("zonpersistentie", self._coordinator.get_zonpersistentie),
            ...
            ("overzichtstatus", self._coordinator.get_overview_status_svg),
            ...
            ("zonband_ijking", self._coordinator.get_pv_band_calibration),
            (
                "weerbron_vergelijking",
                lambda: (
