...
class SolarForecastAccuracyTracker:
    ...
    def _bruikbare_afwijkingen(self) -> list[float]:
        """De afwijkingen waarmee GELEERD wordt (v4.10).

        Dit las de hele `deviation_history`, en die was zeven dagen lang.
        Sinds de geschiedenis veertig dagen bewaart, zou dat het
        leervenster stilzwijgend verzesvoudigen - en dan schuift de
        biascorrectie mee met zonnestanden die niet meer gelden. Het
        venster blijft dus expliciet LEARNING_HISTORY_DAYS; de langere
        reeks is er alleen om terug te kunnen kijken.
        """
        return [
            v
            for v in self.deviation_history[-LEARNING_HISTORY_DAYS:]
            ...
            if actual is not None:
                ...
                if self.pending_predicted_kwh:
                    ...
                    if (
                        ...
                        # v4.10: de GESCHIEDENIS gaat veertig dagen mee;
                        # het leervenster blijft LEARNING_HISTORY_DAYS.
