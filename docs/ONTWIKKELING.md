...
Dit bestand bevat de per-versie verhalen die eerder in `README.md`
stonden. Ze zijn hier bewaard omdat ze vastleggen *waarom* een
beslissing is genomen — vaak nuttiger dan wat er uiteindelijk staat.

Voor de volledige, chronologische lijst met alle wijzigingen zie
